...
export const checkKeycloakEnv = () => {
 console.log("sumeet",process.env.VITE_API_URL)
  const requiredVars = [
    'VITE_KEYCLOAK_URL',
    'VITE_KEYCLOAK_REALM',
  ...
  if (missingVars.length > 0) {
    ...
    return {
      ...
      envVars: {
        ...
        VITE_KEYCLOAK_REALM: import.meta.env.VITE_KEYCLOAK_REALM || 'Not defined',
        VITE_KEYCLOAK_CLIENT_ID: import.meta.env.VITE_KEYCLOAK_CLIENT_ID || 'Not defined'
      }
    };
  }
